...
dataset_text = "/data/saurabh1003/mtp/Shubham/Image_Captioning_model/Flickr8k_text"
dataset_images = "/data/saurabh1003/mtp/Shubham/Image_Captioning_model/Flicker8k_Dataset"
if not os.path.exists(dataset_text):
    print(f"Error: Directory '{dataset_text}' does not exist!")
    exit(1)

if not os.path.exists(dataset_images):
    print(f"Error: Directory '{dataset_images}' does not exist!")
    exit(1)
...
if not os.path.exists(filename):
    ...
    print("Please make sure you have downloaded the Flickr8k dataset and placed it in the correct directory.")
    print("You can download it from: https://www.kaggle.com/datasets/adityajn105/flickr8k")
    exit(1)
...
# model = Xception(include_top=False, pooling='avg', weights="xception_weights.h5")
